...
export class PhoneArrowUpSolid extends React.Component<IIconProps> {
	public render = () => {
		return (
			<>
				<svg
					...
					<path
						clipRule='evenodd'
						fillRule='evenodd'
						d='M15 3.75a.75.75 0 01.75-.75h4.5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0V5.56l-4.72 4.72a.75.75 0 11-1.06-1.06l4.72-4.72h-2.69a.75.75 0 01-.75-.75z'></path>
					<path
						clipRule='evenodd'
						fillRule='evenodd'
